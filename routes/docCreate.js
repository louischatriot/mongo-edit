...
module.exports = function (req, res, next) {
  ...
  collection.indexInformation(function (err, data) {
    ...
    collection.insert(newDoc, { safe: true }, function (err, docs) {
      ...
      return res.redirect('/' + req.params.collection + '/' + docs[0]._id + '/edit?type=alert-success&message=The document was successfully created and persisted to the database, you can edit it now');
    });
  });
