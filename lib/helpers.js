...
module.exports.areIdsEqual = function (id1, id2) {
  if (id1.constructor && id1.constructor.name === 'ObjectID' || id2.constructor && id2.constructor.name === 'ObjectID') {
    return id1.constructor && id1.constructor.name === 'ObjectID' && id2.constructor && id2.constructor.name === 'ObjectID' && id1.toString() === id2.toString();
  } else {
    return id1 === id2;
  }
};
